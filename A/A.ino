...
const float RELAY_THRESHOLD_KVA_1 = 0.3; // Example threshold for RELAY_1 in KVA
const float RELAY_THRESHOLD_KVA_2 = 0.4; // Example threshold for RELAY_2 in KVA
...
void setup() {
  ...
  // Set relay pins to HIGH initially (assuming active-low relays)
