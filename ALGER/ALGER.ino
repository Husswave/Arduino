...
#define RELAY_THRESHOLD_KVA_1 155000 // Example threshold for RELAY_1 in KVA
#define RELAY_THRESHOLD_KVA_2 160000 // Example threshold for RELAY_2 in KVA
...
void loop() {
  ...
  // Delay for a while
  delay(300); // Reduce this delay if you want more frequent updates
