...
const float RELAY_THRESHOLD_KVA_1 = 5.0; // Example threshold for RELAY_1 in KVA
const float RELAY_THRESHOLD_KVA_2 = 8.0; // Example threshold for RELAY_2 in KVA
...
void loop() {
  ...
  // Display main meter reading on the first screen
  lcd.clear();
  ...
  // Display House A and House B readings on the second screen
  lcd.clear();
  lcd.print("House A: ");
